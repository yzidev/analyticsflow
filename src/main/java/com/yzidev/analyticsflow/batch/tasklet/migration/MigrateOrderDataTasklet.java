...
@Component
public class MigrateOrderDataTasklet implements Tasklet {

	private final StagingMigrationService stagingMigrationService;

	public MigrateOrderDataTasklet(StagingMigrationService stagingMigrationService) {
		this.stagingMigrationService = stagingMigrationService;
	}

	@Override
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
		MigrationResult result = stagingMigrationService.migrateOrderData(jobId(chunkContext));
